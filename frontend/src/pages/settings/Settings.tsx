...
export const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl p-4 mx-auto sm:p-6 lg:p-8">
      ...
      <div className="overflow-hidden bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm rounded-xl">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="flex items-center justify-center w-24 h-24 overflow-hidden bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl">
                {logoPreview ? (
                  ...
                  <BuildingOfficeIcon className="w-12 h-12 text-gray-400 dark:text-gray-500" />
                )}
              </div>
              {isEditing && (
                <>
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">
                {isEditing ? (
                  <input
                    ...
                    className="text-xl font-bold text-gray-900 dark:text-gray-100 bg-transparent border-b border-gray-300 dark:border-gray-600 outline-none focus:border-primary-500"
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">
                {isEditing ? (
                  <input
                    ...
                    onChange={handleChange}
                    className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 bg-transparent border-b border-gray-300 dark:border-gray-600 outline-none focus:border-primary-500"
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-6">
            {/* Basic Information */}
            <div>
              <h3 className="flex items-center gap-2 mb-4 text-sm font-semibold text-gray-900 dark:text-gray-100">
      ...
      {/* System Info */}
      <div className="p-4 mt-6 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 rounded-xl">
