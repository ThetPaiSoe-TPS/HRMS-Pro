...
export const EditEmployee: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      date_of_birth: mockEmployee.date_of_birth,
      hire_date: mockEmployee.hire_date,
      department_id: mockEmployee.department_id.toString(),
      position_id: mockEmployee.position_id.toString(),
      employment_status: mockEmployee.employment_status,
      profile_photo: null,
    });
  }, [id]);
