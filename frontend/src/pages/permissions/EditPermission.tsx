  ...
  return (
    <div className="max-w-3xl p-4 mx-auto sm:p-6 lg:p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Permission</h1>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  {formData.name ? (
                    ...
                    <span className="text-gray-400 dark:text-gray-500">Enter a permission name</span>
                  )}
                </span>
                {formData.module && (
