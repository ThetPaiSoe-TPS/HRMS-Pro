  ...
  return (
    <div className="max-w-3xl p-4 mx-auto sm:p-6 lg:p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Apply Leave</h1>
      ...
      {/* Balance Info */}
      <div className="p-4 mb-6 bg-white dark:bg-gray-800 border border-gray-100 shadow-sm rounded-xl">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Leave Balance</p>
            <p className="text-2xl font-bold text-primary-600">{mockBalance.available} days</p>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Total: {mockBalance.total} days</p>
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Used: {mockBalance.used} days</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-primary-500 focus:border-primary-500 ${
                errors.leave_type_id ? 'border-red-300' : 'border-gray-300 dark:border-gray-600'
              }`}
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-primary-500 focus:border-primary-500 ${
                    errors.start_date ? 'border-red-300' : 'border-gray-300 dark:border-gray-600'
                  }`}
                />
              </div>
              {errors.start_date && (
          ...
          {days > 0 && (
            <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700">
              <span className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Total days requested:</span>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={4}
                className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-primary-500 focus:border-primary-500 ${
                  errors.reason ? 'border-red-300' : 'border-gray-300 dark:border-gray-600'
                }`}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <label className="flex-1 cursor-pointer">
                <div className="flex items-center gap-2 px-4 py-2 transition-colors border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-700">
          ...
          {previewUrl && (
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <h4 className="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Attachment Preview</h4>
              <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700">
                <PaperClipIcon className="w-8 h-8 text-gray-400 dark:text-gray-500" />
                <div>
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              className="px-4 py-2 text-gray-700 dark:text-gray-300 transition-colors border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-700"
            >
              Cancel
            </button>
            <button
