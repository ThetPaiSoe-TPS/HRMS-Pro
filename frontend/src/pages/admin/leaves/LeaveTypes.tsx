  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col gap-4 mb-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Leave Types</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {leaveTypes.map((type) => (
          <div key={type.id} className="p-4 transition-shadow bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm rounded-xl hover:shadow-md">
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{type.code}</p>
                </div>
              </div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 line-clamp-2">{type.description}</p>

            <div className="grid grid-cols-2 gap-2 mt-3">
              <div className="p-2 text-center rounded-lg bg-gray-50 dark:bg-gray-700">
                <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Days/Year</p>
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{type.days_per_year}</p>
              </div>
              <div className="p-2 text-center rounded-lg bg-gray-50 dark:bg-gray-700">
          ...
          <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-xl">
            <div className="p-6">
              ...
              <p className="text-sm text-center text-gray-500 dark:text-gray-400 dark:text-gray-500">
                Are you sure you want to delete <span className="font-medium text-gray-900 dark:text-gray-100">{selectedType.name}</span>?
