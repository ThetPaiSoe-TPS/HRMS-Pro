...
//               <div>
//                 <p className="text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-400 dark:text-gray-500">
//                   {stat.title}
//                 </p>
...
//                 <span className="text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">{stat.change}</span>
//               )}
//               <span className="ml-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">from last month</span>
//             </div>
//           </Link>
//         ))}
//       </div>
...
//             <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Attendance Chart</h3>
...
//           <h3 className="mb-4 text-sm font-semibold text-gray-900 dark:text-gray-100">Employee by Department</h3>
...
//         {/* Leave Statistics */}
//         <div className="p-4 bg-white border border-gray-100 shadow-sm dark:bg-gray-800 dark:border-gray-700 rounded-xl">
//           <h3 className="mb-4 text-sm font-semibold text-gray-900 dark:text-gray-100">Leave Statistics</h3>
//           <div className="h-[250px]">
//             <Bar
//               data={leaveChartData}
//               options={{
...
//               >
//                 <div className="flex items-center justify-center flex-shrink-0 w-8 h-8 bg-white rounded-full shadow-sm dark:bg-gray-800 dark:bg-gray-700">
...
//         <div className="p-4 bg-white border border-gray-100 shadow-sm dark:bg-gray-800 dark:border-gray-700 rounded-xl">
//           <div className="flex flex-col justify-between gap-2 mb-4 sm:flex-row sm:items-center">
//             <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Upcoming Holidays</h3>
//             <Link
//               to="/admin/holidays"
//               className="text-xs font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
//             >
...
//               <div
//                 key={holiday.id}
//                 className="flex items-center justify-between p-3 transition-colors border border-gray-100 rounded-lg dark:border-gray-700 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600"
//               >
//                 <div>
//                   <div className="flex items-center gap-2">
//                     <CalendarIcon className="w-4 h-4 text-gray-400 dark:text-gray-500 dark:text-gray-400" />
//                     <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{holiday.name}</p>
//                   </div>
...
//               <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Next Holiday</p>
//               <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
//                 {holidays.length > 0 ? holidays[0].name : 'None'}
//               </p>
//             </div>
//             <div className="p-2 text-center rounded-lg bg-gray-50 dark:bg-gray-700">
//               <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Days Until</p>
...
//           </p>
//           <div className="flex items-center gap-4">
//             <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">PROSPECTING</span>
//             <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">SALES</span>
//             <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">MARKETING</span>
//           </div>
//         </div>
//       </footer>
//     </>
