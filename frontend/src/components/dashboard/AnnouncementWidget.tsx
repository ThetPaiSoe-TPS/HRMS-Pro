...
export const announcementApi = {
  ...
  updateAnnouncement: async (id: number, data: FormData): Promise<Announcement> => {
  ...
  uploadAttachment: async (id: number, file: File): Promise<AnnouncementAttachment> => {
    const formData = new FormData();
    formData.append('attachment', file);
    const response: any = await api.post(`/announcements/${id}/attachments`, formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
    return response;
  },
